...
export function Onboarding({ onDone }: Props): React.ReactNode {
	...
	const isOpencode = process.env.OPEN_CLAUDE_ENABLED === "true";
	const [skipOAuth, setSkipOAuth] = useState(isOpencode);
	...
	const apiKeyNeedingApproval = useMemo(() => {
		// Skip API key approval dialog when using opencode free tier
