...
async function main(): Promise<void> {
	...
	(globalThis as any).__TRACE?.("cli.tsx: importing main.js");
	const { main: cliMain } = await import("../main.js");
	(globalThis as any).__TRACE?.("cli.tsx: imported main.js");
	profileCheckpoint("cli_after_main_import");
	(globalThis as any).__TRACE?.("cli.tsx: calling cliMain()");
	await cliMain();
	(globalThis as any).__TRACE?.("cli.tsx: cliMain() returned");
