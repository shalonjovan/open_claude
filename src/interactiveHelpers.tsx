...
export async function showSetupScreens(
	...
	if (!isEnvTruthy(process.env.CLAUBBIT)) {
		// In opencode mode, skip the trust dialog entirely and auto-accept
		if (process.env.OPEN_CLAUDE_ENABLED !== "true") {
	...
	// Check for custom API key — skip when using opencode free tier
	if (
		process.env.OPEN_CLAUDE_ENABLED !== "true" &&
